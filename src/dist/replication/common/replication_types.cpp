...
void group_check_response::__set_bulk_load_context_cleaned(const bool val)
{
    this->bulk_load_context_cleaned = val;
    __isset.bulk_load_context_cleaned = true;
}
    ...
    while (true) {
        ...
        case 9:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->bulk_load_context_cleaned);
                this->__isset.bulk_load_context_cleaned = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t group_check_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    if (this->__isset.bulk_load_context_cleaned) {
        xfer += oprot->writeFieldBegin(
            "bulk_load_context_cleaned", ::apache::thrift::protocol::T_BOOL, 9);
        xfer += oprot->writeBool(this->bulk_load_context_cleaned);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
    xfer += oprot->writeStructEnd();
...
void swap(group_check_response &a, group_check_response &b)
{
    ...
    swap(a.bulk_load_context_cleaned, b.bulk_load_context_cleaned);
    swap(a.__isset, b.__isset);
}
...
group_check_response::group_check_response(const group_check_response &other76)
{
    ...
    bulk_load_context_cleaned = other76.bulk_load_context_cleaned;
...
group_check_response::group_check_response(group_check_response &&other77)
{
    ...
    bulk_load_context_cleaned = std::move(other77.bulk_load_context_cleaned);
...
group_check_response &group_check_response::operator=(const group_check_response &other78)
{
    ...
    bulk_load_context_cleaned = other78.bulk_load_context_cleaned;
...
group_check_response &group_check_response::operator=(group_check_response &&other79)
{
    ...
    bulk_load_context_cleaned = std::move(other79.bulk_load_context_cleaned);
...
void group_check_response::printTo(std::ostream &out) const
{
    ...
    (__isset.bulk_load_download_progress ? (out << to_string(bulk_load_download_progress))
                                         : (out << "<null>"));
    out << ", "
        << "bulk_load_context_cleaned=";
    (__isset.bulk_load_context_cleaned ? (out << to_string(bulk_load_context_cleaned))
                                       : (out << "<null>"));
    out << ")";
}
...
configuration_query_bulk_load_request::configuration_query_bulk_load_request(
    const configuration_query_bulk_load_request &other585)
{
    app_name = other585.app_name;
    __isset = other585.__isset;
}
configuration_query_bulk_load_request::configuration_query_bulk_load_request(
    configuration_query_bulk_load_request &&other586)
{
    app_name = std::move(other586.app_name);
    __isset = std::move(other586.__isset);
}
configuration_query_bulk_load_request &configuration_query_bulk_load_request::
operator=(const configuration_query_bulk_load_request &other587)
{
    app_name = other587.app_name;
    __isset = other587.__isset;
    return *this;
}
configuration_query_bulk_load_request &configuration_query_bulk_load_request::
operator=(configuration_query_bulk_load_request &&other588)
{
    app_name = std::move(other588.app_name);
...
void configuration_query_bulk_load_response::__set_partition_status(
    ...
    while (true) {
        ...
        case 3:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->app_status = (::dsn::bulk_load_status::type)ecast589;
        ...
        case 4:
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    this->partition_status.clear();
                    uint32_t _size590;
                    ::apache::thrift::protocol::TType _etype593;
                    xfer += iprot->readListBegin(_etype593, _size590);
                    this->partition_status.resize(_size590);
                    uint32_t _i594;
                    for (_i594 = 0; _i594 < _size590; ++_i594) {
                        int32_t ecast595;
                        xfer += iprot->readI32(ecast595);
                        this->partition_status[_i594] = (::dsn::bulk_load_status::type)ecast595;
                    }
                    xfer += iprot->readListEnd();
                }
                this->__isset.partition_status = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->download_progresses.resize(_size596);
                    uint32_t _i600;
                    for (_i600 = 0; _i600 < _size596; ++_i600) {
                        {
                            this->download_progresses[_i600].clear();
                            uint32_t _size601;
                            ...
                            for (_i605 = 0; _i605 < _size601; ++_i605) {
                                ::dsn::rpc_address _key606;
                                xfer += _key606.read(iprot);
                                partition_download_progress &_val607 =
                                    this->download_progresses[_i600][_key606];
                                xfer += _val607.read(iprot);
                            }
                            xfer += iprot->readMapEnd();
                        }
                    }
...
configuration_query_bulk_load_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("partition_status", ::apache::thrift::protocol::T_LIST, 4);
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32,
                                      static_cast<uint32_t>(this->partition_status.size()));
        std::vector<::dsn::bulk_load_status::type>::const_iterator _iter608;
        for (_iter608 = this->partition_status.begin(); _iter608 != this->partition_status.end();
             ++_iter608) {
    ...
    if (this->__isset.download_progresses) {
            ...
            oprot->writeFieldBegin("download_progresses", ::apache::thrift::protocol::T_LIST, 6);
        {
            ...
            std::vector<std::map<::dsn::rpc_address, partition_download_progress>>::const_iterator
                _iter609;
            for (_iter609 = this->download_progresses.begin();
                 _iter609 != this->download_progresses.end();
                 ++_iter609) {
                {
                    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRUCT,
                                                 ::apache::thrift::protocol::T_STRUCT,
                                                 static_cast<uint32_t>((*_iter609).size()));
                    std::map<::dsn::rpc_address, partition_download_progress>::const_iterator
                        _iter610;
                    for (_iter610 = (*_iter609).begin(); _iter610 != (*_iter609).end();
                         ++_iter610) {
                        xfer += _iter610->first.write(oprot);
...
configuration_query_bulk_load_response::configuration_query_bulk_load_response(
    const configuration_query_bulk_load_response &other611)
{
    err = other611.err;
...
configuration_query_bulk_load_response::configuration_query_bulk_load_response(
    configuration_query_bulk_load_response &&other612)
{
...
configuration_query_bulk_load_response &configuration_query_bulk_load_response::
operator=(const configuration_query_bulk_load_response &other613)
{
    err = other613.err;
...
configuration_query_bulk_load_response &configuration_query_bulk_load_response::
operator=(configuration_query_bulk_load_response &&other614)
{
    ...
    while (true) {
        ...
        case 6:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->app_bl_status = (::dsn::bulk_load_status::type)ecast615;
...
bulk_load_request::bulk_load_request(const bulk_load_request &other616)
{
    pid = other616.pid;
    app_name = other616.app_name;
    primary_addr = other616.primary_addr;
    remote_provider_name = other616.remote_provider_name;
    cluster_name = other616.cluster_name;
    app_bl_status = other616.app_bl_status;
    partition_bl_info = other616.partition_bl_info;
    __isset = other616.__isset;
}
bulk_load_request::bulk_load_request(bulk_load_request &&other617)
{
    pid = std::move(other617.pid);
    app_name = std::move(other617.app_name);
    primary_addr = std::move(other617.primary_addr);
    remote_provider_name = std::move(other617.remote_provider_name);
    cluster_name = std::move(other617.cluster_name);
    app_bl_status = std::move(other617.app_bl_status);
    partition_bl_info = std::move(other617.partition_bl_info);
    __isset = std::move(other617.__isset);
}
bulk_load_request &bulk_load_request::operator=(const bulk_load_request &other618)
{
    pid = other618.pid;
    app_name = other618.app_name;
    primary_addr = other618.primary_addr;
    remote_provider_name = other618.remote_provider_name;
    cluster_name = other618.cluster_name;
    app_bl_status = other618.app_bl_status;
    partition_bl_info = other618.partition_bl_info;
    __isset = other618.__isset;
    return *this;
}
bulk_load_request &bulk_load_request::operator=(bulk_load_request &&other619)
{
    pid = std::move(other619.pid);
    app_name = std::move(other619.app_name);
    primary_addr = std::move(other619.primary_addr);
    remote_provider_name = std::move(other619.remote_provider_name);
    cluster_name = std::move(other619.cluster_name);
    app_bl_status = std::move(other619.app_bl_status);
    partition_bl_info = std::move(other619.partition_bl_info);
...
void bulk_load_response::__set_context_clean_flags(const std::map<::dsn::rpc_address, bool> &val)
{
    this->context_clean_flags = val;
    __isset.context_clean_flags = true;
}
    ...
    while (true) {
        ...
        case 4:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->partition_bl_status = (::dsn::bulk_load_status::type)ecast620;
            ...
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    ...
                    for (_i625 = 0; _i625 < _size621; ++_i625) {
                        ::dsn::rpc_address _key626;
                        xfer += _key626.read(iprot);
                        partition_download_progress &_val627 = this->download_progresses[_key626];
        ...
        case 7:
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    this->context_clean_flags.clear();
                    uint32_t _size628;
                    ...
                    for (_i632 = 0; _i632 < _size628; ++_i632) {
                        ::dsn::rpc_address _key633;
                        xfer += _key633.read(iprot);
                        bool &_val634 = this->context_clean_flags[_key633];
                        xfer += iprot->readBool(_val634);
                    }
                    xfer += iprot->readMapEnd();
                }
                this->__isset.context_clean_flags = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t bulk_load_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("partition_bl_status", ::apache::thrift::protocol::T_I32, 4);
    xfer += oprot->writeI32((int32_t)this->partition_bl_status);
    xfer += oprot->writeFieldEnd();

    if (this->__isset.download_progresses) {
        xfer += oprot->writeFieldBegin("download_progresses", ::apache::thrift::protocol::T_MAP, 5);
        {
            xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRUCT,
                                         ::apache::thrift::protocol::T_STRUCT,
                                         static_cast<uint32_t>(this->download_progresses.size()));
            std::map<::dsn::rpc_address, partition_download_progress>::const_iterator _iter635;
            for (_iter635 = this->download_progresses.begin();
                 _iter635 != this->download_progresses.end();
                 ++_iter635) {
                xfer += _iter635->first.write(oprot);
                xfer += _iter635->second.write(oprot);
            }
            xfer += oprot->writeMapEnd();
        }
        xfer += oprot->writeFieldEnd();
    ...
    if (this->__isset.total_download_progress) {
        xfer +=
            oprot->writeFieldBegin("total_download_progress", ::apache::thrift::protocol::T_I32, 6);
        xfer += oprot->writeI32(this->total_download_progress);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.context_clean_flags) {
        xfer += oprot->writeFieldBegin("context_clean_flags", ::apache::thrift::protocol::T_MAP, 7);
        {
            xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRUCT,
                                         ::apache::thrift::protocol::T_BOOL,
                                         static_cast<uint32_t>(this->context_clean_flags.size()));
            std::map<::dsn::rpc_address, bool>::const_iterator _iter636;
            for (_iter636 = this->context_clean_flags.begin();
                 _iter636 != this->context_clean_flags.end();
                 ++_iter636) {
                xfer += _iter636->first.write(oprot);
                xfer += oprot->writeBool(_iter636->second);
            }
            xfer += oprot->writeMapEnd();
        }
        xfer += oprot->writeFieldEnd();
...
void swap(bulk_load_response &a, bulk_load_response &b)
{
    ...
    swap(a.context_clean_flags, b.context_clean_flags);
    swap(a.__isset, b.__isset);
}

bulk_load_response::bulk_load_response(const bulk_load_response &other637)
{
    err = other637.err;
    pid = other637.pid;
    app_name = other637.app_name;
    partition_bl_status = other637.partition_bl_status;
    download_progresses = other637.download_progresses;
    total_download_progress = other637.total_download_progress;
    context_clean_flags = other637.context_clean_flags;
    __isset = other637.__isset;
}
bulk_load_response::bulk_load_response(bulk_load_response &&other638)
{
    err = std::move(other638.err);
    pid = std::move(other638.pid);
    app_name = std::move(other638.app_name);
    partition_bl_status = std::move(other638.partition_bl_status);
    download_progresses = std::move(other638.download_progresses);
    total_download_progress = std::move(other638.total_download_progress);
    context_clean_flags = std::move(other638.context_clean_flags);
    __isset = std::move(other638.__isset);
}
bulk_load_response &bulk_load_response::operator=(const bulk_load_response &other639)
{
    err = other639.err;
    pid = other639.pid;
    app_name = other639.app_name;
    partition_bl_status = other639.partition_bl_status;
    download_progresses = other639.download_progresses;
    total_download_progress = other639.total_download_progress;
    context_clean_flags = other639.context_clean_flags;
    __isset = other639.__isset;
    return *this;
}
bulk_load_response &bulk_load_response::operator=(bulk_load_response &&other640)
{
    err = std::move(other640.err);
    pid = std::move(other640.pid);
    app_name = std::move(other640.app_name);
    partition_bl_status = std::move(other640.partition_bl_status);
    download_progresses = std::move(other640.download_progresses);
    total_download_progress = std::move(other640.total_download_progress);
    context_clean_flags = std::move(other640.context_clean_flags);
