...
//        return dsn::ERR_OK;
//    }
//    virtual dsn::error_code copy_checkpoint_to_dir(const char *checkpoint_dir, int64_t
//    *last_decree)
//    {
//        *last_decree = DECREE;
//        return dsn::ERR_OK;
...
//    // override
//    void
//    child_init_replica(dsn::gpid gpid_parent, dsn::rpc_address primary_address, ballot
//    init_ballot);
//    void
...
// dsn::replication::replica_ptr replica_stub_mock::get_replica(dsn::gpid pid, bool
// create_if_possible)
//{
...
// void replica_split_mock::child_init_replica(dsn::gpid gpid_parent,
//                                            dsn::rpc_address primary_address,
//                                            ballot init_ballot)
//{
//    auto iter = mock_funcs.find("child_init_replica");
...
//        }
//    } else {
//        dsn::replication::replica::child_init_replica(gpid_parent, primary_address, init_ballot);
//    }
//}
...
// void replica_split_mock::update_group_partition_count(int new_partition_count, bool
// is_update_child)
//{
