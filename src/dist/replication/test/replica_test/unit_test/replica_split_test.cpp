...
//            plist_mock->put(mu);
//            _parent->_private_log->append(mu, LPC_WRITE_REPLICATION_LOG_PRIVATE, nullptr,
//            nullptr);
//        }
...
//            _mock_plist->put(mu);
//            if (add_to_plog) {
//                rep->_private_log->append(mu, LPC_WRITE_REPLICATION_LOG_PRIVATE, nullptr,
//                nullptr);
//                mu->set_logged();
//            }
//        }
...
//    void mock_child_split_context(gpid parent_gpid, bool is_prepare_list_copied, bool
//    is_caught_up)
//    {
//        _child->_split_states.parent_gpid = parent_gpid;
//        _child->_split_states.is_prepare_list_copied = is_prepare_list_copied;
...
//        std::shared_ptr<prepare_list> plist = std::make_shared<prepare_list>(_parent,
//        *_mock_plist);
...
//    fail::setup();
//    fail::cfg("replica_stub_on_exec3", "return()");
...
//    fail::cfg("replica_stub_on_exec6", "return()");
