...
//    mutation_log_private_mock *log_mock = new mutation_log_private_mock(child_gpid,
//    child_replica);
//    child_replica->_private_log = log_mock;
...
//    {
//        notify_cacth_up_response response;
//        primary_replica->_primary_states.child_address.insert(dsn::rpc_address("127.0.0.1",
//        8702));
//        primary_replica->_primary_states.child_address.insert(dsn::rpc_address("127.0.0.2",
//        8702));
//        primary_replica->_primary_states.child_address.insert(dsn::rpc_address("127.0.0.3",
//        8702));
...
//    {
//        primary_replica->_child_init_ballot = 0;
...
//        child_replica->_config.status = partition_status::PS_PARTITION_SPLIT;
//        primary_replica->_child_init_ballot = BALLOT;
//        primary_replica->_child_gpid = child_gpid;
//    }
