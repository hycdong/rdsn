...
GENERATED_TYPE_SERIALIZATION(ddd_diagnose_request, THRIFT)
GENERATED_TYPE_SERIALIZATION(ddd_node_info, THRIFT)
GENERATED_TYPE_SERIALIZATION(ddd_partition_info, THRIFT)
GENERATED_TYPE_SERIALIZATION(ddd_diagnose_response, THRIFT)
}
}
