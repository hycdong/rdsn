...
typedef struct _partition_configuration__isset {
  _partition_configuration__isset() : pid(false), ballot(false), max_replica_count(false), primary(false), secondaries(false), last_drops(false), last_committed_decree(false), partition_flags(false), load_status(true) {}
  bool pid :1;
  bool ballot :1;
...
class partition_configuration {
 public:
  ...
  partition_configuration() : ballot(0), max_replica_count(0), last_committed_decree(0), partition_flags(0), load_status((bulk_load_status::type)0) {
...
typedef struct _app_info__isset {
  _app_info__isset() : status(true), app_type(false), app_name(false), app_id(false), partition_count(false), envs(false), is_stateful(false), max_replica_count(false), expire_second(false), create_second(false), drop_second(false) {}
  bool status :1;
  bool app_type :1;
  bool app_name :1;
  bool app_id :1;
...
class app_info {
 public:
  ...
  app_info() : status((app_status::type)0), app_type(), app_name(), app_id(0), partition_count(0), is_stateful(0), max_replica_count(0), expire_second(0), create_second(0), drop_second(0) {
